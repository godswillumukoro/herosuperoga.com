        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="relative" uk-slideshow="ratio: 6:3;animation: pull;min-height: 300; max-height: 600">
                ...
                <ul class="uk-slideshow-items rounded-2xl">
                    <?php
                    $conn = mysqli_connect('167.99.193.7', 'herosuper', '8f19d5cfa468e3cbd3936331f73e1', 'image_upload');

                    $query = "SELECT `image_name` FROM `image` ORDER BY `id` ASC";
                    ...
                    ?>
                            <li>
                                <img src="<?= "dashboard/media-update/images/" . $image; ?>" alt="" class="object-cover w-full h-full inset-0">
                            </li>
                    <?php
                        }
                    }

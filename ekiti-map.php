...
<div class="section main__section bg-white">
    <div class="container buttons">
        ...
        <div id="ekiti-map" class="maps"></div>
    </div>
</div>
...
// One
$result1 = $mysqli->query("SELECT `name`, `lat`, `longitude` FROM ekiti_rider_list WHERE `position` = 1") or die($mysqli->error);
...
// Two
$result2 = $mysqli->query("SELECT `name`, `lat`, `longitude` FROM ekiti_rider_list WHERE `position` = 2") or die($mysqli->error);
...
// Three
$result3 = $mysqli->query("SELECT `name`, `lat`, `longitude` FROM ekiti_rider_list WHERE `position` = 3") or die($mysqli->error);
...
// Four
$result4 = $mysqli->query("SELECT `name`, `lat`, `longitude` FROM ekiti_rider_list WHERE `position` = 4") or die($mysqli->error);
...
// Five
$result5 = $mysqli->query("SELECT `name`, `lat`, `longitude` FROM ekiti_rider_list WHERE `position` = 5") or die($mysqli->error);
